          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-1 space-y-4">
              ...
              <div className="glass-card p-4 space-y-4">
                <div className="flex items-center gap-3 px-4 bg-[var(--color-dark-800)] border border-[var(--color-glass-border)] rounded-xl group transition-all focus-within:border-[var(--color-accent)]">
                <svg className="w-5 h-5 text-[var(--color-txt-muted)] group-focus-within:text-[var(--color-accent)] transition-colors shrink-0" 
                ...
                <input
                  ...
                  className="flex-1 py-2 bg-transparent text-sm text-white placeholder:text-[var(--color-txt-muted)] outline-none"
                />
              </div>
